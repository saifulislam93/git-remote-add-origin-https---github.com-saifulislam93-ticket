	...
	padding-left:25px;
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <?= form_open('orderadd',array('class' => 'form-horizontal','role'=>'form')) ?>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Customer Name </label>
                            <div class="col-sm-9">
                                <input type="text"  placeholder="Full Name" name="customer_name" value="<?=  set_value('customer_name','') ?>" class="col-xs-10 col-sm-7" />
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text"  placeholder="Contact Number" name="contact_no" value="<?=  set_value('contact_no','') ?>" class="col-xs-10 col-sm-7" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" placeholder="Journy Date" name="journey_date" value="<?= set_value('journey_date',date('Y-m-d')) ?>" class="col-xs-10 col-sm-7 journey_date" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="Journy Time" onkeyup="avail_seat_cal(this.value)" name="journey_time" value="<?= set_value('journey_time','') ?>" class="col-xs-10 col-sm-7 input-mask-time journey_time" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="Fare" name="fare" value="<?=  set_value('fare','') ?>" class="col-xs-10 col-sm-7 fare" />
                                <?= form_error('fare') ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" onkeyup="fare_cal(this.value)" placeholder="Number Of Seat" name="no_of_seat" value="<?=  set_value('no_of_seat','') ?>" class="col-xs-10 col-sm-7" />
		...
		<!-- select ship_id,journey_date,journey_time,from_location,sum(no_of_seat) FROM tbl_order GROUP BY from_location,journey_time,journey_date,ship_id-->
